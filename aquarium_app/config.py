...
ELEMENT_COLORS: dict[str, str] = {
    "po4": "#51cf66", "no3": "#ff922b", "k": "#845ef7", "fe": "#a0522d",
...
RATIO_GUIDELINES: list[dict] = [
    {
        ...
        "low_note": "NO3 занижен относительно PO4 (или PO4 в избытке). Некоторые считают, "
                    "что это повышает риск водорослей — если они появляются, попробуйте "
                    "немного поднять дозу NO3 либо снизить PO4.",
        "high_note": "PO4 занижен относительно NO3. Обычно не страшно, но если растения "
                     "растут медленно или мельчают — попробуйте немного поднять PO4.",
    },
    {
        "num": "k", "den": "no3", "label": "K:NO3",
        "lo": 0.5, "hi": 2.0, "hint": "ориентир ~1:1–1.5:1, метод EI",
        "low_note": "Калий занижен относительно азота. При явных признаках нехватки K "
                    "(дырки и пятна на старых листьях) можно немного увеличить дозу калия.",
        "high_note": "Калий вносится с запасом относительно азота. Обычно не критично — "
                     "калий редко бывает токсичен даже в повышенных дозах.",
    },
    {
        "num": "fe", "den": "mn", "label": "Fe:Mn",
        "lo": 1.5, "hi": 3.5, "hint": "ориентир ~2:1–3:1, большинство трейс-миксов",
        "low_note": "Марганца относительно много по сравнению с железом — обычно не проблема.",
        "high_note": "Железа относительно много по сравнению с марганцем. Обычно не страшно, "
                     "но при пожелтении молодых листьев между прожилками (частый признак "
                     "нехватки Mn) стоит добавить марганец.",
    },
]